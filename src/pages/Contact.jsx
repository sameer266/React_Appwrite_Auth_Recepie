...
function Contact() {
  return (
    <div class=" contact mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-[#2e0249] rounded-lg">
            <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                ...
                <div class="bg-gray-100 p-6 rounded-lg">
                    ...
                    <div class="space-y-4 max-lg:mt-4">
                        <button type="button" class="px-4 py-2 rounded-lg bg-[#a91079] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#a91079] mr-4">Web design</button>
